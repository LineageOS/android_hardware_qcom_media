...
else ifeq ($(TARGET_BOARD_PLATFORM),msmfalcon)
MM_CORE_TARGET = msmfalcon
else
...
ifneq (,$(filter msm8916 msm8994 msm8909 msm8937 msm8996 msm8992 msm8952 msm8953 msm8998 msmfalcon,$(TARGET_BOARD_PLATFORM)))
